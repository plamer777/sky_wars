...
class TestHeroFactory:
    ...
    def test_get_full_info(self, unit_factory) -> None:
    ...
    def test_get_unit_class(self, unit_factory) -> None:
        ...
        hero_classes = names.get('classes')
        equip_list = product(names.get('weapons'), names.get('armors'))
    ...
    @staticmethod
    def _create_test_units(unit_factory,
                           requests_list: Iterable[UserRequest]) -> dict[
                           str, List[EnemyUnit | UserUnit]]:
